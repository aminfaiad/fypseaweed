...
#def simulator(url = "http://localhost/Real/api.php"):
    dadata= data={"farm_token" : "6a208f040cc1e8f29e87ce75263186f4" , "ph_value" : random.randint(8,9) , "temperature" : random.randint(28,32)  , "salinity" : random.randint(32,33) , "light_intensity" : random.randint(29,50), "sonic_distance" : random.randint(29,50)} #SAFE VALUE
